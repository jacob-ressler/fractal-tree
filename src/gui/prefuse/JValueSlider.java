...
/*
 * This class was taken from the Prefuse software tool source code, which is open source.
 * The JValueSlider class allows for the creation of sliders with attached text input. The main reason for inclusion
 * is establish a unified UI design, as JRangeSliders (also from Prefuse) will be used.
 */
...
public class JValueSlider extends JComponent {
    ...
    /**
     * Get the current value associated with the slider position.
