...
public class RangeSliderDemo extends JPanel {
    ...
    public RangeSliderDemo() {
        ...
        add(rangeSliderLabel2, new GridBagConstraints(2, 0, 2, 1, 0.0, 0.0,
            GridBagConstraints.NORTHWEST, GridBagConstraints.NONE, new Insets(0, 0, 3, 3), 5, 0));
        add(rangeSliderValue2, new GridBagConstraints(4, 0, 1, 1, 0.0, 0.0,
